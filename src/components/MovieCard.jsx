  ...
  return (
    <div className="w-full max-w-sm bg-zinc-800 border border-zinc-700 rounded-lg shadow flex flex-col mx-auto ms:mx-0">
        ...
        <div className="px-5 pb-5 h-full flex flex-col">
            <a href="#" className='block mb-[12px]'>
            ...
            <a href="#" className="block w-full text-white bg-amber-500 hover:bg-amber-600 focus:ring-4 focus:outline-none focus:ring-amber-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mt-auto transition-colors ease-linear delay-20">Detail</a>
        </div>
    </div>
  )
}
